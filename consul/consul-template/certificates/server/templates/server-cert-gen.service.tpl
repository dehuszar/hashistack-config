...
ExecStart=/bin/bash -c "/usr/local/bin/consul-template -config=/etc/consul-template.d/certificates/consul/build-consul-server-certs.hcl -log-level=debug -once"